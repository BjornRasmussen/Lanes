...
public class UtilsRender {
    ...
    public final static Image bike = ImageProvider.get("roadmarkings", "bike.png").getImage();
    public final static Image bus = ImageProvider.get("roadmarkings", "bus.png").getImage();
    public final static Image car = ImageProvider.get("roadmarkings", "car.png").getImage();
    public final static Image hov = ImageProvider.get("roadmarkings", "hov.png").getImage();
    public final static Image hov2 = ImageProvider.get("roadmarkings", "hov2.png").getImage();
    public final static Image hov3 = ImageProvider.get("roadmarkings", "hov3.png").getImage();
    public final static Image hov4 = ImageProvider.get("roadmarkings", "hov4.png").getImage();
    public final static Image hov5 = ImageProvider.get("roadmarkings", "hov5.png").getImage();
    public final static Image hov6 = ImageProvider.get("roadmarkings", "hov6.png").getImage();
    public final static Image moped = ImageProvider.get("roadmarkings", "moped.png").getImage();
    public final static Image motorcycle = ImageProvider.get("roadmarkings", "motorcycle.png").getImage();
    public final static Image pedestrian = ImageProvider.get("roadmarkings", "ped.png").getImage();
    public final static Image taxi = ImageProvider.get("roadmarkings", "taxi.png").getImage();
    public final static Image tram = ImageProvider.get("roadmarkings", "tram.png").getImage();
    public final static Image truck = ImageProvider.get("roadmarkings", "truck.png").getImage();
    ...
    public final static Image lr_bike = ImageProvider.get("lowresroadmarkings", "bike.png").getImage();
    public final static Image lr_bus = ImageProvider.get("lowresroadmarkings", "bus.png").getImage();
    public final static Image lr_car = ImageProvider.get("lowresroadmarkings", "car.png").getImage();
    public final static Image lr_hov = ImageProvider.get("lowresroadmarkings", "hov.png").getImage();
    public final static Image lr_hov2 = ImageProvider.get("lowresroadmarkings", "hov2.png").getImage();
    public final static Image lr_hov3 = ImageProvider.get("lowresroadmarkings", "hov3.png").getImage();
    public final static Image lr_hov4 = ImageProvider.get("lowresroadmarkings", "hov4.png").getImage();
    public final static Image lr_hov5 = ImageProvider.get("lowresroadmarkings", "hov5.png").getImage();
    public final static Image lr_hov6 = ImageProvider.get("lowresroadmarkings", "hov6.png").getImage();
    public final static Image lr_moped = ImageProvider.get("lowresroadmarkings", "moped.png").getImage();
    public final static Image lr_motorcycle = ImageProvider.get("lowresroadmarkings", "motorcycle.png").getImage();
    public final static Image lr_pedestrian = ImageProvider.get("lowresroadmarkings", "ped.png").getImage();
    public final static Image lr_taxi = ImageProvider.get("lowresroadmarkings", "taxi.png").getImage();
    public final static Image lr_tram = ImageProvider.get("lowresroadmarkings", "tram.png").getImage();
    public final static Image lr_truck = ImageProvider.get("lowresroadmarkings", "truck.png").getImage();
